...
average_loan_amount = sum / len(loan_costs)

print("Total number of loans:", len(loan_costs))
print("Total value of loans:", sum)
...
future_value = float(loan.get("future_value"))
remaining_months = float(loan.get("remaining_months"))
